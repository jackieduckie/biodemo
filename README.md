...
This program is released as open source software under the terms of [MIT License](https://raw.githubusercontent.com/jackieduckie/biodemo/master/LICENSE).

# Installing

Clone this repository: 
```
$ git clone https://github.com/jackieduckie/biodemo
```
...
[biodemo issue tracker](https://github.com/jackieduckie/biodemo/issues)
